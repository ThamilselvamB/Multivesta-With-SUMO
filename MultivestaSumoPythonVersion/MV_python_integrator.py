...
class SimulationWrapper(object):
	...
	def setSimulatorForNewSimulation(self, random_seed):
		#print("RESET OF SIMULATOR IS GOING ON.............")
	...
	def performOneStepOfSimulation(self):
		#print("ONE STEP OF SIMULATOR IS GOING ON.............")
		self.model.one_step()
	...
	def rval(self, observation):
		#print("RVAL OF SIMULATOR IS GOING ON.............")
...
if __name__ == '__main__':
	...
	#model=model_file_name.Model("ourModel")
	model = sumo_runner.SumoSimulation()
