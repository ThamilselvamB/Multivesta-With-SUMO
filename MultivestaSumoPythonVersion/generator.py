...
class TrafficGenerator:
    ...
    def generate_routefile(self, n_cars_generated, seed):
        """
        ...
        with open("intersection/in/route/my_grid.veh.rou.xml", "w") as routes:
            print("""<routes>
            <vType accel="1.0" decel="4.5" id="standard_car" length="5.0" minGap="2.5" maxSpeed="25" sigma="0.5" />

            <route id="W_N" edges="A2B2 B2B3"/>
            <route id="W_E" edges="A2B2 B2C2"/>
            <route id="W_S" edges="A2B2 B2B1"/>
            <route id="N_W" edges="B3B2 B2A2"/>
            <route id="N_E" edges="B3B2 B2C2"/>
            <route id="N_S" edges="B3B2 B2B1"/>
            <route id="E_W" edges="C2B2 B2A2"/>
            <route id="E_N" edges="C2B2 B2B3"/>
            <route id="E_S" edges="C2B2 B2B1"/>
            <route id="S_W" edges="B1B2 B2A2"/>
            <route id="S_N" edges="B1B2 B2B3"/>
            <route id="S_E" edges="B1B2 B2C2"/>""", file=routes)
...
TrafficGenerator = TrafficGenerator(100,300)
TrafficGenerator.generate_routefile(100,2)
